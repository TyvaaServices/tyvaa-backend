...
module.exports = (fastify) => ({
    ...
    login: async (req, reply) => {
        ...
        try {
            ...
            const token = fastify.signToken({id: user.id, phoneNumber: user.phoneNumber, isDriver: user.isDriver});
            logger.info(`Authentication token generated for user ${user.id}`);
