    ...
    paths: {
      ...
      '/api/v1/rides': {
        get: {
          ...
          responses: {
            '200': { description: 'List of rides', schema: { type: 'array', items: { $ref: '#/definitions/Ride' } } },
          },
        },
        post: {
          tags: ['Rides'],
      ...
      '/api/v1/bookings': {
        get: {
          ...
          responses: {
            '200': { description: 'List of bookings', schema: { type: 'array', items: { $ref: '#/definitions/Booking' } } },
          },
        },
        post: {
          tags: ['Bookings'],
      ...
      '/api/v1/ratings': {
        get: {
          ...
          responses: {
            '200': { description: 'List of ratings', schema: { type: 'array', items: { $ref: '#/definitions/Rating' } } },
          },
        },
        post: {
          tags: ['Ratings'],
      ...
      '/api/v1/notifications': {
        get: {
          ...
          responses: {
            '200': { description: 'List of notifications', schema: { type: 'array', items: { $ref: '#/definitions/Notification' } } },
          },
        },
      },
      '/api/v1/chatbot': {
        post: {
          ...
          parameters: [{ in: 'body', name: 'message', schema: { type: 'object', properties: { message: { type: 'string' }, personality: { type: 'string', enum: ['f', 'm'] } } } }],
          responses: {
            '200': { description: 'Chatbot reply', schema: { type: 'object', properties: { reply: { type: 'string' } } } },
          },
        },
      },
    },
