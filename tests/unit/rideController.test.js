...
jest.unstable_mockModule(
    "../../src/modules/ride-module/facades/rideFacade.js",
    () => ({
        __esModule: true,
...
describe("Ride Controller (with Facade)", () => {
    ...
    beforeEach(async () => {
        ...
        rideController = (
            await import(
                "../../src/modules/ride-module/controllers/rideController.js"
            )
        ).default;
    });
    ...
    describe("getAllRides", () => {
        ...
        it("should throw on error", async () => {
            ...
            await expect(
                rideController.getAllRides(mockRequest, mockReply)
    ...
    describe("getRideById", () => {
        ...
        it("should throw on error", async () => {
            ...
            mockRequest.params.id = "1";
            await expect(
                rideController.getRideById(mockRequest, mockReply)
            ).rejects.toThrow("fail");
        });
    });
    ...
    describe("createRide", () => {
        ...
        it("should throw on error", async () => {
            ...
            mockRequest.body = { data: "test" };
            await expect(
                rideController.createRide(mockRequest, mockReply)
            ).rejects.toThrow("fail");
        });
    });
    ...
    describe("updateRide", () => {
        ...
        it("should throw on error", async () => {
            ...
            mockRequest.body = { data: "update" };
            await expect(
                rideController.updateRide(mockRequest, mockReply)
            ).rejects.toThrow("fail");
        });
    });
    ...
    describe("deleteRide", () => {
        ...
        it("should throw on error", async () => {
            ...
            mockRequest.params.id = "1";
            await expect(
                rideController.deleteRide(mockRequest, mockReply)
            ).rejects.toThrow("fail");
        });
    });
    ...
    describe("getAllRideInstances", () => {
        it("should return ride instances on success", async () => {
            ...
            mockRideFacade.getAllRideInstances.mockResolvedValueOnce(
                rideInstances
            );
        ...
        it("should handle errors", async () => {
            mockRideFacade.getAllRideInstances.mockRejectedValueOnce(
                new Error("fail")
            );
            await expect(
                rideController.getAllRideInstances(mockRequest, mockReply)
            ).rejects.toThrow("fail");
        });
    });
    ...
    describe("getRideInstanceById", () => {
        it("should return ride instance on success", async () => {
            ...
            mockRideFacade.getRideInstanceById.mockResolvedValueOnce(
                rideInstance
            );
            mockRequest.params.id = "1";
        ...
        it("should return 404 if not found", async () => {
            ...
            expect(mockReply.code).toHaveBeenCalledWith(404);
            expect(mockReply.send).toHaveBeenCalledWith({
                error: "RideInstance not found",
            });
        });
        it("should handle errors", async () => {
            mockRideFacade.getRideInstanceById.mockRejectedValueOnce(
                new Error("fail")
            );
            mockRequest.params.id = "1";
            await expect(
                rideController.getRideInstanceById(mockRequest, mockReply)
            ).rejects.toThrow("fail");
        });
    });
    ...
    describe("createRideInstance", () => {
        it("should create ride instance and return result", async () => {
            const rideInstance = { id: 1 };
            mockRideFacade.createRideInstance.mockResolvedValueOnce(
                rideInstance
            );
            mockRequest.body = { data: "test" };
        ...
        it("should handle errors", async () => {
            mockRideFacade.createRideInstance.mockRejectedValueOnce(
                new Error("fail")
            );
            mockRequest.body = { data: "test" };
            await expect(
                rideController.createRideInstance(mockRequest, mockReply)
            ).rejects.toThrow("fail");
        });
    });
    ...
    describe("updateRideInstance", () => {
        it("should update ride instance and return result", async () => {
            const rideInstance = { id: 1 };
            mockRideFacade.updateRideInstance.mockResolvedValueOnce(
                rideInstance
            );
            mockRequest.params.id = "1";
            mockRequest.body = { data: "update" };
        ...
        it("should handle errors", async () => {
            mockRideFacade.updateRideInstance.mockRejectedValueOnce(
                new Error("fail")
            );
            mockRequest.params.id = "1";
            mockRequest.body = { data: "update" };
            await expect(
                rideController.updateRideInstance(mockRequest, mockReply)
            ).rejects.toThrow("fail");
        });
    });
    ...
    describe("deleteRideInstance", () => {
        ...
        it("should handle errors", async () => {
            mockRideFacade.deleteRideInstance.mockRejectedValueOnce(
                new Error("fail")
            );
            mockRequest.params.id = "1";
            await expect(
                rideController.deleteRideInstance(mockRequest, mockReply)
            ).rejects.toThrow("fail");
        });
    });
    ...
    describe("acceptRide", () => {
        ...
        it("should handle errors", async () => {
            ...
            mockRequest.params.id = "1";
            await expect(
                rideController.acceptRide(mockRequest, mockReply)
            ).rejects.toThrow("fail");
        });
    });
    ...
    describe("rejectRide", () => {
        ...
        it("should handle errors", async () => {
            ...
            mockRequest.params.id = "1";
            await expect(
                rideController.rejectRide(mockRequest, mockReply)
            ).rejects.toThrow("fail");
        });
    });
    ...
    describe("completeRide", () => {
        ...
        it("should handle errors", async () => {
            mockRideFacade.completeRide.mockRejectedValueOnce(
                new Error("fail")
            );
            mockRequest.params.id = "1";
            await expect(
                rideController.completeRide(mockRequest, mockReply)
            ).rejects.toThrow("fail");
        });
    });
});
